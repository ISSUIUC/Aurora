 ...
 * They can help to specify the slot and clock configurations for initialization or updating */
    i2s_pdm_rx_config_t std_cfg = {
        .slot_cfg = I2S_PDM_RX_SLOT_RAW_FMT_DEFAULT_CONFIG(I2S_DATA_BIT_WIDTH_8BIT, I2S_SLOT_MODE_MONO),
        // .clk_cfg = {
        //     .sample_rate_hz = 8e6,
        ...
        //     .bclk_div = 8
        // },
        .clk_cfg=I2S_PDM_RX_CLK_DEFAULT_CONFIG(4e6),
//         .clk_cfg={
//     .sample_rate_hz = 4e6,
...
// },
    ...
    int ret2 = i2s_channel_init_pdm_rx_mode(rx_handle, &std_cfg);
